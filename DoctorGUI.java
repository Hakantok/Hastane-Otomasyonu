...
public class DoctorGUI extends JFrame {
	...
	public DoctorGUI(Doctor doctor) throws SQLException {
		...
		lblNewLabel.setBounds(11, 17, 300, 39);
		...
		btnNewButton.setBounds(621, 22, 105, 29);
		...
		select_time.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 12));
		...
		select_time.setBounds(146, 10, 65, 20);
		...
		btn_addWhour.setBounds(221, 10, 65, 20);
		w_whour.add(btn_addWhour);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(0, 40, 711, 307);
		...
		btn_deleteWhour.setBounds(636, 10, 65, 20);
