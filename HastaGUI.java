...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		w_scrollDoctor.setBounds(10, 30, 280, 324);
		...
		lblNewLabel_1.setBounds(11, 13, 95, 13);
		...
		lblPoliklinikAd.setBounds(296, 8, 96, 18);
		w_appointment.add(lblPoliklinikAd);

		JComboBox select_clinic = new JComboBox();
		select_clinic.setBounds(295, 31, 150, 33);
		...
		lblPoliklinikAd_1.setBounds(295, 100, 96, 18);
		...
		btn_selDoctor.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 14));
		btn_selDoctor.setBounds(293, 118, 152, 34);
		...
		lblNewLabel_1_1.setBounds(452, 10, 249, 19);
		w_appointment.add(lblNewLabel_1_1);

		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(451, 30, 250, 324);
		...
		lblPoliklinikAd_1_1.setBounds(295, 190, 96, 18);
		...
		btn_addAppoint.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 14));
		btn_addAppoint.setBounds(293, 208, 152, 34);
		...
		w_scrollAppoint.setBounds(10, 10, 691, 344);
