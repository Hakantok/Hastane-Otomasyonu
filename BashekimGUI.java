...
public class BashekimGUI extends JFrame {
	...
	public BashekimGUI(Bashekim bashekim) throws SQLException {
		...
		lblNewLabel.setBounds(10, 10, 300, 39);
		...
		btnNewButton.setBounds(621, 15, 105, 29);
		...
		btn_addDoctor.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 14));
		btn_addDoctor.setBounds(508, 204, 179, 34);
		...
		label_3.setBounds(508, 246, 119, 18);
		w_doctor.add(label_3);

		fld_doctorID = new JTextField();
		fld_doctorID.setBounds(508, 268, 179, 28);
		...
		btn_delDoctor.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 14));
		btn_delDoctor.setBounds(508, 306, 179, 34);
		w_doctor.add(btn_delDoctor);

		JScrollPane w_scrollDoctor = new JScrollPane();
		w_scrollDoctor.setBounds(10, 10, 493, 330);
		...
		w_scrollClinic.setBounds(10, 10, 251, 340);
		...
		lblPoliklinikAd.setBounds(271, 10, 96, 18);
		w_clinic.add(lblPoliklinikAd);

		fld_clinicName = new JTextField();
		fld_clinicName.setColumns(10);
		fld_clinicName.setBounds(271, 32, 152, 28);
		...
		btn_addClinic.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 14));
		btn_addClinic.setBounds(271, 70, 152, 34);
		w_clinic.add(btn_addClinic);

		JScrollPane w_scrollWorker = new JScrollPane();
		w_scrollWorker.setBounds(432, 10, 263, 340);
		...
		select_doctor.setBounds(272, 262, 151, 34);
		for (int i = 0; i < bashekim.getDoctorList().size(); i++) {
		...
		btn_addWorker.setBounds(271, 306, 153, 34);
		...
		lblPoliklinikAd_1.setBounds(271, 146, 96, 18);
		...
		btn_workerSelect.setBounds(271, 169, 152, 34);
